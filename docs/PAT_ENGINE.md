...
> This is the README for the **engine** BOATZ is built on, kept here for reference. The
> project README is at the [repo root](../README.md); the engine's own home is
> [prdoring/Pat_Engine](https://github.com/prdoring/Pat_Engine).

![Pat_Engine](screenshots/banner.png)
...
![The Pat_Engine editor suite: art, music, soundboard, and sequence editors](screenshots/hero-editors.png)
...
- **Game:** <http://localhost:6970/>. Click the ground to spawn critters, click a
  ...
  zoom.
- **Editor suite:** <http://localhost:6970/editor>. See the **[Editor Guide](EDITORS.md)**.
...
![Shot harness contact sheet](screenshots/shots-contact-sheet.png)
...
<tr>
<td><img src="screenshots/example-subgame.png" alt="Sub Game: the submarine loadout screen"></td>
<td><img src="screenshots/example-marklikey.png" alt="Mark Likey: the Reckoning, where guesses meet the Marky's true rating"></td>
</tr>
</table>
...
- **Editor suite:** all of the above in one tabbed browser app with a file-based
  save/backup pipeline. See the **[Editor Guide](EDITORS.md)**.
...
<img src="screenshots/shot-garden-busy.png" alt="Critter Garden example game" width="640">
...
`data/.backups/` (details in the [Editor Guide](EDITORS.md)).
...
| Doc | What it covers |
|---|---|
| [docs/EDITORS.md](EDITORS.md) | User guide to every editor tool, with screenshots |
